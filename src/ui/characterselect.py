...
class CharacterSelect:
    def __init__(self, screen, bg, fsm):
        ...
        self.elvenWarrior_crop = pygame.image.load("../assets/selectchar/fantasywarrior.png").convert_alpha()
        self.darkWizard_crop = pygame.image.load("../assets/selectchar/evilwizard.png").convert_alpha()
