            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if elvenWarrior_button.checkForInput(mouse_pos):
                    ...
                    if p1_selected == False:
                        ...
                        f2 = Fighter(1, 700, 310, False, ew_data, ew_sheet, ew_animations_steps, ew_soundfx, ew_volume)     
                        return f1,f2
                if darkWizard_button.checkForInput(mouse_pos):
                    ...
                    if p1_selected == False:
                        f1 = Fighter(2, 200, 310, True, dw_data, dw_sheet, dw_animations_steps, dw_soundfx, dw_volume)
                        p1_selected = True
